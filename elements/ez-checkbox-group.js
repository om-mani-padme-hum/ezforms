...
EZCheckboxGroup.prototype.addDivClass = function (className) {
...
EZCheckboxGroup.prototype.addLabelClass = function (className) {
...
EZCheckboxGroup.prototype.removeDivClass = function (className) {
...
EZCheckboxGroup.prototype.removeLabelClass = function (className) {
...
EZCheckboxGroup.prototype.render = function (indent = 0) {
  /** Validate cols */
  if ( this.cols() < 1 || this.cols() > 16 )
    throw new RangeError(`EZCheckboxGroup.render(): Invalid number, cols must be between 1 and 16 inclusive.`);
...
module.exports.EZCheckboxGroup = EZCheckboxGroup;
